    ...
    return (<>
        <Box sx={{ display: 'flex', flexDirection: 'column', borderRight: '1px solid #e9e9e9', backgroundColor: '#fff' }}>
            <Box sx={{ display: 'flex', height: '100%', alignItems: 'center', flexDirection: 'column', gap: 3, pt: 2, pb: 2, pr: 1, pl: 1 }}>
                <img alt="Logo" src="sapere.svg" width="50" />
                <NavBarButton startIcon={<LibraryBooksOutlined sx={{ width: 25, height: 25 }} />} onClick={() => selectMenu(0)} sx={{ backgroundColor: selected === 0 ? '#e4eff6' : 'transparent' }}>
                    <Typography noWrap variant="body2" fontWeight={700}>
                        Sessions
                    </Typography>
                </NavBarButton>
                <NavBarButton startIcon={<SchoolOutlined sx={{ width: 25, height: 25 }} />} onClick={() => selectMenu(0)} sx={{ backgroundColor: selected === 1 ? '#e4eff6' : 'transparent' }}>
                    <Typography noWrap variant="body2" fontWeight={700}>
                        Students
                    </Typography>
                </NavBarButton>
                ...
                <Box sx={{ display: 'flex', flexDirection: 'column', gap: 1, pb: 1 }}>
                    <NavBarButton
                        ...
                        sx={{ backgroundColor: selected === 4 ? '#e4eff6' : 'transparent' }}>
