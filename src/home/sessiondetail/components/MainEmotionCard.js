...
const MainEmotionCard = ({ emotion }) => {
    ...
    return (
        <Box sx={{ height: 200, backgroundColor: 'white', border: '2px solid, #e9e9e9', borderRadius: '6px', display: 'flex', flexDirection: 'column', p: 2, gap: 2 }}>
            <Typography variant="body2" sx={{ fontWeight: 700 }}>Main Emotion</Typography>
